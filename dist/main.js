...
const pageLoad = function() {
    let tasks = _Todo_js__WEBPACK_IMPORTED_MODULE_0__["default"].tasks.slice();
...
const projectListener = function(event) {
    document.querySelector('.main-subtitle').textContent = event.target.textContent;
    let tasks = _Project_js__WEBPACK_IMPORTED_MODULE_1__["default"].projects[parseInt(event.target.id)].tasks;
    const mainTasks = document.querySelector('.show-tasks');
...
const newProjectHandler = function(event) {
    ...
    yes.addEventListener('click', (event) => {
        event.preventDefault();
        new _Project_js__WEBPACK_IMPORTED_MODULE_1__["default"](event.target.parentNode.projectName.value);
        const projects = document.querySelector('.projects');
        projects.innerHTML = '';
        event.target.parentNode.remove();
        _Project_js__WEBPACK_IMPORTED_MODULE_1__["default"].projects.forEach((project, index) => {
...
const newTaskHandler = function(event) {
    ...
    button.addEventListener('click', (event) => {
        ...
        const newTask = new _Todo_js__WEBPACK_IMPORTED_MODULE_0__["default"](taskForm.title.value, taskForm.description.value, currDate, taskForm.priority.value);
        
        if (taskForm.select.selectedIndex > 0){
            const project = _Project_js__WEBPACK_IMPORTED_MODULE_1__["default"].projects[taskForm.select.selectedIndex - 1];
            console.log(project);
