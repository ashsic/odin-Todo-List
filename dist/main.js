...
/* harmony export */   addButtonHandlers: () => (/* binding */ addButtonHandlers),
/* harmony export */   addHomeListeners: () => (/* binding */ addHomeListeners),
...
/* harmony import */ var date_fns__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! date-fns */ "./node_modules/date-fns/isSameWeek.mjs");
/* harmony import */ var date_fns__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! date-fns */ "./node_modules/date-fns/isSameMonth.mjs");
...
const pageLoad = function () {
  const tasks = _Todo__WEBPACK_IMPORTED_MODULE_0__["default"].tasks.slice();
...
const appendTasks = function (tasks, appendTo) {
  ...
  tasks.forEach((task) => {
    ...
    li.textContent = `${task.title} ${(0,date_fns__WEBPACK_IMPORTED_MODULE_2__.format)(task.dueDate, 'MMMM do, yyyy')}`;
...
const homeListener = function (event) {
  ...
  let tasks = _Todo__WEBPACK_IMPORTED_MODULE_0__["default"].tasks.slice();
  const mainTasks = document.querySelector('.show-tasks');

  tasks = tasks.filter((task) => {
    if (event.target.value == 1) return true;
    if (event.target.value == 2) return (0,date_fns__WEBPACK_IMPORTED_MODULE_3__.isSameDay)(task.dueDate, new Date());
    if (event.target.value == 3) return (0,date_fns__WEBPACK_IMPORTED_MODULE_4__.isSameWeek)(task.dueDate, new Date());
    if (event.target.value == 4) return (0,date_fns__WEBPACK_IMPORTED_MODULE_5__.isSameMonth)(task.dueDate, new Date());
  });
...
const projectListener = function (event) {
  document.querySelector('.main-subtitle').textContent = event.target.textContent;
  const { tasks } = _Project__WEBPACK_IMPORTED_MODULE_1__["default"].projects[parseInt(event.target.id)];
  const mainTasks = document.querySelector('.show-tasks');
...
const newProjectHandler = function (event) {
  ...
  yes.addEventListener('click', (event) => {
    event.preventDefault();
    new _Project__WEBPACK_IMPORTED_MODULE_1__["default"](event.target.parentNode.projectName.value);
...
const newTaskHandler = function (event) {
  ...
  button.addEventListener('click', (event) => {
    ...
    const newTask = new _Todo__WEBPACK_IMPORTED_MODULE_0__["default"](taskForm.title.value, taskForm.description.value, currDate, taskForm.priority.value);

    if (taskForm.select.selectedIndex > 0) {
      const project = _Project__WEBPACK_IMPORTED_MODULE_1__["default"].projects[taskForm.select.selectedIndex - 1];
      console.log(project);
...
class Project {
    ...
    static deleteTodo(id) {
        _Todo_js__WEBPACK_IMPORTED_MODULE_0__["default"].tasks = _Todo_js__WEBPACK_IMPORTED_MODULE_0__["default"].tasks.filter((task) => {
            return task._id != id;
        });
